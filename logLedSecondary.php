...
$valor_LedPortaTraseira = file_get_contents("api/sensores_atuadores/LedPortaTraseira/valor.txt");
$data_LedPortaTraseira = file_get_contents("api/sensores_atuadores/LedPortaTraseira/data.txt");
$log_LedPortaTraseira= file_get_contents("api/sensores_atuadores/LedPortaTraseira/log.txt");
$nome_LedPortaTraseira = file_get_contents("api/sensores_atuadores/LedPortaTraseira/nome.txt");
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <img src="Icons/LedOff.png" alt="secondary led"   
                        width="50" 
                        height="50">
                            <div class="ms-3">
                                <p class="mb-2">Secondary led: <?php echo $valor_LedPortaTraseira; ?></p>
                                <h6 class="mb-0">Last updated: <?php echo $data_LedPortaTraseira; ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                        <table class="table table-dark">
                                ...
                                <?php 
                                    ...
                                    $linhas = file("api/sensores_atuadores/LedPortaTraseira/log.txt");
