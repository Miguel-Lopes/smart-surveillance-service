            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <img src="Icons/buzzer.png" alt="Buzzer actuator"   
                        width="50" 
                        height="50">
                            <div class="ms-3">
                                <p class="mb-2">Buzzer: <?php echo $valor_Buzzer; ?></p>
                                <h6 class="mb-0">Last updated: <?php echo $data_Buzzer; ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                        ...
                        <thead>
                                ...
                                <?php 
                                    ...
                                    $linhas = file("api/sensores_atuadores/Buzzer/log.txt");
