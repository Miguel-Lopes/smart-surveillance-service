            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <img src="Icons/doorClosed.png" alt="back door actuator"   
                        width="50" 
                        height="50">
                            <div class="ms-3">
                                <p class="mb-2">Back door: <?php echo $valor_Porta_Traseira; ?></p>
                                <h6 class="mb-0">Last updated: <?php echo $data_Porta_Traseira; ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                        <table class="table table-dark">
                                ...
                                <?php 
                                    ...
                                    $linhas = file("api/sensores_atuadores/PortaTraseira/log.txt");
