                ...
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="row">
                            <div class="col-sm-6">
                                ...
                                if (file_exists("credentials/" . $_SESSION["username"] . "/photo.PNG")) {
                                    echo "<img class='img-fluid rounded-circle mx-auto mb-4' src='credentials/" . $_SESSION["username"] . "/photo.PNG' alt='' style='width: 200px; height: 200px;' id='profilePhoto'>";
                                } else {
                                    echo "<img class='img-fluid rounded-circle mx-auto mb-4' src='img/default_account-removebg-preview.PNG' alt='' style='width: 200px; height: 200px;' id='profilePhoto'>";
                                }
                                ?>
                                <div class="mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <button type="button" class="btn btn-outline-danger m-2">Eliminar Conta</button>
                            </div>
                        </div>
                    </form>
                    <!-- Recent Sales End -->
