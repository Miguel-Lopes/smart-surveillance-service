...
$valor_LedPortaPrincipal = file_get_contents("api/sensores_atuadores/LedPortaPrincipal/valor.txt");
$data_LedPortaPrincipal = file_get_contents("api/sensores_atuadores/LedPortaPrincipal/data.txt");
$log_LedPortaPrincipal= file_get_contents("api/sensores_atuadores/LedPortaPrincipal/log.txt");
$nome_LedPortaPrincipal = file_get_contents("api/sensores_atuadores/LedPortaPrincipal/nome.txt");
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <img src="Icons/LedOff.png" alt="main led"   
                        width="50" 
                        height="50">
                            <div class="ms-3">
                                <p class="mb-2">Main led: <?php echo $valor_LedPortaPrincipal; ?></p>
                                <h6 class="mb-0">Last updated: <?php echo $data_LedPortaPrincipal; ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-12">
                        <table class="table table-dark">
                                <thead>
                                    <tr><th>Log main led</th></tr>
                                               </thead>
                                <tbody>
                                <?php 
                                    //vai buscar o conteudo do ficheiro
                                    $linhas = file("api/sensores_atuadores/LedPortaPrincipal/log.txt");
                                    ...
                                    foreach ($linhasInvertidas as $linha) {
                                        list($data_Porta_Principa, $valor_LedPortaPrincipal) = explode(":#:", $linha);

                                        echo "<tr>
                                        <td>".$data_LedPortaPrincipal."</td>
                                        <td>".$valor_LedPortaPrincipal."</td>
                                             </tr>" ;
                                    }
                                ?>
                                </tbody>
